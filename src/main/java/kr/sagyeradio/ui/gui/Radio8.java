...
public class Radio8 extends Radio {

    private boolean leftpreDown = false;

    private ResourceLocation bg = new ResourceLocation("olivemodradio", "textures/gui/8.png");
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.bg = new ResourceLocation("olivemodradio", "textures/gui/8.png");
