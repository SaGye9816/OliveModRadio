...
public class Radio2 extends Radio {

    private boolean leftpreDown = false;

    private ResourceLocation bg = new ResourceLocation("olivemodradio", "textures/gui/2.png");
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.bg = new ResourceLocation("olivemodradio", "textures/gui/2.png");
